HW-16: Airport Management Application with Observer Design Pattern and Lambda Expressions

This application demonstrates an Airport Management Application with Observer Design Pattern and Lambda Expressions. The application allows flight display boards and websites to receive flight departure and arrival events.
...
3. Observer Implementations(Replaced with Lambda Expressions):
